...
class Study(object):
    ...
    inputs : Dict[str, FilesetInput | FilesetSpec | FieldInput | FieldSpec] | List[FilesetInput | FilesetSpec | FieldInput | FieldSpec]
        Either a list or a dictionary containing FilesetInput,
        FieldInput, FilesetSpec, or FieldSpec objects, which specify the
        ...
        if not isinstance(inputs, dict):
            ...
            for inpt_name, inpt in list(inputs.items()):
                if isinstance(inpt, basestring):
                    ...
                    if spec.is_fileset:
                        inpt = FilesetInput(inpt_name, pattern=inpt)
                    else:
                        inpt = FieldInput(inpt_name, pattern=inpt,
                                             dtype=spec.dtype)
