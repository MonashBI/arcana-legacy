...
import shutil
from arcana import (
    StudyMetaClass, Study, DirRepository, LinearProcessor, FilesetSpec,
    FilesetMatch)
...
norm = NormalClass('norm', DirRepository(ARCHIVE_DIR),
                   LinearProcessor(WORK_DIR),
                   inputs=[FilesetMatch('fileset', text_format,
                                           'fileset')])


gen = GeneratedClass('gen', DirRepository(ARCHIVE_DIR),
                     LinearProcessor(WORK_DIR),
                     inputs=[FilesetMatch('fileset', text_format,
                                          'fileset')])
