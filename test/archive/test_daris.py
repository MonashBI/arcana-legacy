...
class TestDarisSourceAndSink(TestCase):
    ...
    def test_source_and_sink_roundtrip(self):
        ...
        try:
            # Create working dirs
            rmtree_ignore_missing(self.CACHE_DIR)
            rmtree_ignore_missing(self.WORKFLOW_DIR)
            os.makedirs(self.CACHE_DIR)
            os.makedirs(self.WORKFLOW_DIR)
            # Create DarisSource node
            ...
            source.inputs.files = [
                ('source1', 'source1.nii.gz', False),
                ('source2', 'source2.nii.gz', False),
                ('source3', 'source3.nii.gz', False),
                ('source4', 'source4.nii.gz', False)]
