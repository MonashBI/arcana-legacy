...
from arcana.environment.requirement import PythonPackageRequirement
...
class TestRequirements(TestCase):
    ...
    def test_version_split(self):
        self.assertEqual(a_req.parse_version('12.2.9'), (12, 2, 9))
    ...
    def test_exceptions(self):
        ...
        self.assertRaises(
            ...
            a_req_rnge.latest_available,
            ['2.0.0', '1.9.1'])
        self.assertRaises(
            ArcanaRequirementVersionException,
            b_req_rnge.latest_available,
            ['2.2.0', '3.4.1'])
