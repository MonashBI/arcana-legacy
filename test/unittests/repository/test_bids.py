...
class TestBidsRepository(BaseTestCase):
    ...
    def setUp(self):
        self._repository = BidsRepository()
    ...
    def test_repository_roundtrip(self):
        ...
        workflow.run()
        # Check bids directory was created properly
        outputs = [
    ...
    def test_fields_roundtrip(self):
        repository = BidsRepository(base_dir=self.project_dir)
    ...
    def test_summary(self):
        ...
        visit_sink = self.repository.sink(
            visit_sink_files, frequency='per_visit',
            study_name=self.SUMMARY_STUDY_NAME)
        ...
        project_sink = self.repository.sink(
            project_sink_files, frequency='per_project',
            study_name=self.SUMMARY_STUDY_NAME)
        ...
        workflow.run()
        # Check bids summary directories were created properly
...
class TestProjectInfo(BaseMultiSubjectTestCase):
    ...
    @property
    def input_tree(self):
        return self.get_tree(self.bids_repository)

    def test_project_info(self):
        # Add hidden file to bids repository at project and subject
        ...
        self.assertEqual(
            ...
            .format(tree.find_mismatch(self.bids_tree)))


class TestBidsInterfacePickle(TestCase):
