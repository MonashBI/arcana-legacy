...
_cite = Citation(
    short_name='',
    authors=['Desikan, R.S.', ' Segonne, F.', ' Fischl, B.', ' Quinn, B.T.', ' Dickerson, B.C.', ' Blacker, D.', ' Buckner, R.L.', ' Dale, A.M.', ' Maguire, R.P.', ' Hyman, B.T.', ' Albert, M.S.', ' Killiany, R.J.'],
...
_cite = Citation(
    short_name='',
    authors=['Fischl, B.', ' Salat, D.H.', ' Busa, E.', ' Albert, M.', ' Dieterich, M.', ' Haselgrove, C.', ' van der Kouwe, A.', ' Killiany, R.', ' Kennedy, D.', ' Klaveness, S.', ' Montillo, A.', ' Makris, N.', ' Rosen, B.', ' Dale, A.M.'],
...
_cite = Citation(
    short_name='',
    authors=['Fischl, B.', ' Salat, D.H.', ' van der Kouwe, A.J.', ' Makris, N.', ' Segonne, F.', ' Quinn, B.T.', ' Dale, A.M.'],
...
_cite = Citation(
    short_name='',
    authors=['Fischl, B.', ' van der Kouwe, A.', ' Destrieux, C.', ' Halgren, E.', ' Segonne, F.', ' Salat, D.H.', ' Busa, E.', ' Seidman, L.J.', ' Goldstein, J.', ' Kennedy, D.', ' Caviness, V.', ' Makris, N.', ' Rosen, B.', ' Dale, A.M.'],
...
_cite = Citation(
    short_name='',
    authors=['Han, X.', ' Jovicich, J.', ' Salat, D.', ' van der Kouwe, A.', ' Quinn, B.', ' Czanner, S.', ' Busa, E.', ' Pacheco, J.', ' Albert, M.', ' Killiany, R.', ' Maguire, P.', ' Rosas, D.', ' Makris, N.', ' Dale, A.', ' Dickerson, B.', ' Fischl, B.'],
...
_cite = Citation(
    short_name='',
    authors=['Jovicich, J.', ' Czanner, S.', ' Greve, D.', ' Haley, E.', ' van der Kouwe, A.', ' Gollub, R.', ' Kennedy, D.', ' Schmitt, F.', ' Brown, G.', ' Macfall, J.', ' Fischl, B.', ' Dale, A.'],
...
_cite = Citation(
    short_name='',
    authors=['Kuperberg, G.R.', ' Broome, M.R.', ' McGuire, P.K.', ' David, A.S.', ' Eddy, M.', ' Ozawa, F.', ' Goff, D.', ' West, W.C.', ' Williams, S.C.', ' van der Kouwe, A.J.', ' Salat, D.H.', ' Dale, A.M.', ' Fischl, B.'],
...
_cite = Citation(
    short_name='',
    authors=['Rosas, H.D.', ' Liu, A.K.', ' Hersch, S.', ' Glessner, M.', ' Ferrante, R.J.', ' Salat, D.H.', ' van der Kouwe, A.', ' Jenkins, B.G.', ' Dale, A.M.', ' Fischl, B.'],
...
_cite = Citation(
    short_name='',
    authors=['Salat, D.H.', ' Buckner, R.L.', ' Snyder, A.Z.', ' Greve, D.N.', ' Desikan, R.S.', ' Busa, E.', ' Morris, J.C.', ' Dale, A.M.', ' Fischl, B.'],
...
_cite = Citation(
    short_name='',
    authors=['Segonne, F.', ' Dale, A.M.', ' Busa, E.', ' Glessner, M.', ' Salat, D.', ' Hahn, H.K.', ' Fischl, B.'],
