...
class Study(object):
    ...
    Class Attributes
    ----------------
    adds_data_specs : List[DatasetSpec|FieldSpec]
    ...
    adds_option_specs : Dict[str, int|float|str]
        ...
        for base in reversed(bases):
            try:
                combined_data_specs.update(
                    (d.name, d) for d in base.adds_data_specs)
            except AttributeError:
                pass
            try:
                combined_option_specs.update(
                    (o.name, o) for o in base.adds_option_specs)
            except AttributeError:
                pass
        combined_data_specs.update((d.name, d) for d in adds_data_specs)
        combined_option_specs.update(
            (o.name, o) for o in adds_option_specs)
