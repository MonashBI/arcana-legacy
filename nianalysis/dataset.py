...
class Dataset(object):
    ...
    pipeline. It is also used as a placeholder in the Study classes to
    specify which datasets are expected to be provided ("acquired
    datasets") or will be generated by the pipelines associated with the study
    ("generated datasets").
