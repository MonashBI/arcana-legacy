...
import arcana.archive.local  # @UnusedImport @IgnorePep8
import arcana.archive.xnat  # @UnusedImport @IgnorePep8
...
latex_documents = [
  (master_doc, 'arcana.tex', u'Arcana Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'arcana', u'Arcana Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Arcana', u'Arcana Documentation',
   author, 'Arcana', 'Archive-centered analysis of neuroimaging data',
   'Miscellaneous'),
]
