...
The Arcana package itself only provides the abstract *Analysis* and
...
be sub-classed further into classes that are specific to the a particular
analysis, and integrate the complete workflow from preprocessing to statistic
analysis.
